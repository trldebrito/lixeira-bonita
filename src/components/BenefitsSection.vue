<template>
  <section class="py-24 bg-[#E9EEF2]">
    <div class="max-w-[1200px] mx-auto px-6">
      ...
      <div class="w-full max-w-4xl mx-auto h-[350px] md:h-[500px] bg-[#B0B7BE] rounded-[40px] mb-20 flex items-center justify-center relative shadow-sm">
        <button class="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-lg hover:scale-105 transition-transform pl-1">
